          ...
          <div className="container mx-auto px-8 sm:px-12 lg:px-16 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-justify">
                ...
                <p>
                  <b>LEARN</b>, about current research and applications of recent
                  technologies such as wind, photovoltaics, fuel cells,
                  distributed generation, flexible AC transmission, energy
                  storage, Smart Grids and more.
                </p>
                <p>
                  <b>STAY INFORMED</b>, about the latest developments in
                  traditional technologies and the new opportunities created as
                  today’s technological and financial situations impact the power
                  and energy industry.
                </p>
                <p>
                  <b>NETWORK</b>, with experienced professionals in all aspects of
                  the industry be that local, regional or international meetings.
                  Save big on conference registration fees, some are even free!
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-8 sm:px-12 lg:px-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              <BenefitCard icon={<Lightbulb size={40} />}>
                Being a PES student member, gain access to the digital library of
                IEEE Xplore.
              </BenefitCard>
              <BenefitCard icon={<Globe size={40} />}>
                Build a network into the field of your preference on the
                professional front.
              </BenefitCard>
              <BenefitCard icon={<Atom size={40} />}>
                Ultimately, learn new things setting a PES member apart from the
                others
              </BenefitCard>
            </div>
          </div>
