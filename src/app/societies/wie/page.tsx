...
export default function WiePage() {
  const missionContent = (
    <div className="text-left space-y-4">
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>Recognize the outstanding achievements of women in electrical and electronics engineering through IEEE Awards nominations.</li>
        <li>Organize receptions at major technical conferences to enhance networking and to promote membership in WIE.</li>
        <li>Advocate for women in leadership roles in IEEE governance, and career advancement for women in the profession.</li>
        <li>Provide assistance with the formation of new WIE Affinity Groups, and support ongoing activities.</li>
      </ul>
      <p>Conduct weekly activities exclusively for woman Student members. An event christened “Techno Glee” is organized only for woman student members where a participant is given a random topic and they have to prepare a presentation on it using the given resources in the given time period.</p>
    </div>
  );
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              IEEE Women in Engineering (WIE) is one of the largest international professional organizations dedicated to promoting women engineers, scientists, and inspiring girls around the world to follow their academic interests in a career in engineering.
            </p>
          </div>
      ...
      {/* Section 3: Custom CTA Banner for WIE */}
      <CtaBanner
