...
const carouselImages = Array.from({ length: 8 }, (_, i) => `/placeholders/carousel/slide-${i + 1}.jpg`);
const resourceLinks = [
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {resourceLinks.map((link) => (
                <div key={link.title} className="bg-white p-6 rounded-lg shadow-md text-center">
                  ...
                  <Link href={link.href} target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-md hover:bg-blue-500 transition-colors">
                    VISIT NOW
                  </Link>
                </div>
              ))}
